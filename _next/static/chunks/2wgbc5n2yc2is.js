(globalThis.TURBOPACK||(globalThis.TURBOPACK=[])).push(["object"==typeof document?document.currentScript:void 0,60305,e=>{"use strict";var r=e.i(43476),a=e.i(71645);let n=[{id:"NA",label:"NA",host:"api-us",code:3},{id:"EU",label:"EU",host:"api-eu",code:4},{id:"Asia",label:"Asia",host:"api-ap",code:2},{id:"Japan",label:"Japan",host:"api",code:1}],i="slime-news-region";e.s(["NewsClient",0,function(){let e,[o,s]=(0,a.useState)("NA");(0,a.useEffect)(()=>{try{let e=localStorage.getItem(i);e&&n.some(r=>r.id===e)&&s(e)}catch{}},[]);let t=n.find(e=>e.id===o)??n[0];return(0,r.jsxs)("div",{className:"nk-news",children:[(0,r.jsx)("div",{className:"nk-news-regions",role:"tablist","aria-label":"Server region",children:n.map(e=>(0,r.jsx)("button",{type:"button",role:"tab","aria-selected":e.id===o,onClick:()=>(function(e){s(e);try{localStorage.setItem(i,e)}catch{}})(e.id),className:`nk-news-region${e.id===o?" is-active":""}`,children:e.label},e.id))}),(0,r.jsx)("div",{className:"nk-news-frame",children:(0,r.jsx)("iframe",{title:`In-game notices (${t.label})`,src:(e="Japan"===t.id?1:2,`https://${t.host}.ten-sura-m.wfs.games/web/announcement?region=${t.code}&language=${e}`),referrerPolicy:"strict-origin-when-cross-origin",loading:"lazy"},t.id)}),(0,r.jsx)("p",{className:"nk-news-note",children:"Official in-game notices, served live by the game per region. Switch regions above."}),(0,r.jsx)("style",{children:`
        ...
        .nk-news-frame {
          ...
          border: 1px solid rgba(255, 255, 255, 0.12);
          background: #fff;
          box-shadow: 0 18px 48px rgba(6, 12, 32, 0.45);
        }
